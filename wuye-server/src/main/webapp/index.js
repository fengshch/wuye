...
jQuery(document).ready(function($) {
    ...
    $.ajax({
        ...
        showMeYourJqXHR('When GET /ttt/rest/hello is done', jqXHR);
        showMeYourCookies('When GET /ttt/rest/hello is done');
        ...
        showMeYourJqXHR('When GET /ttt/rest/hello fails', jqXHR);
        showMeYourCookies('When GET /ttt/rest/hello fails');
